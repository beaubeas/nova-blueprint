...
DEFAULT_SECRET="jesusban-secret-key-change-me"
...
if [ -z "$CURRENT_SECRET" ]; then
    ...
    echo "    docker exec -it jesusban-backend python -c \"import secrets; print(secrets.token_hex(32))\""
    echo ""
