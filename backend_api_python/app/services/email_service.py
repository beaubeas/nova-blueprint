...
class EmailService:
    ...
    def send_verification_code(self, email: str, code_type: str, 
        ...
        if code_type == 'register':
            subject = 'App - Verification Code for Registration'
            action_text = 'complete your registration'
        elif code_type == 'login':
            subject = 'App - Quick Login Verification Code'
            action_text = 'log in to your account'
        elif code_type == 'reset_password':
            subject = 'App - Password Reset Verification Code'
            action_text = 'reset your password'
        elif code_type == 'change_password':
            subject = 'App - Verification Code for Password Change'
            action_text = 'change your password'
        elif code_type == 'change_email':
            subject = 'App - Verification Code for Email Change'
        ...
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
            <div style="text-align: center; margin-bottom: 30px;">
                <h1 style="color: #1890ff; margin: 0;">App</h1>
