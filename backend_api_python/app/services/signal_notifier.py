...
"""
    ...
    def _notify_webhook(
        ...
        *,
        ...
        headers: Dict[str, str] = {
            ...
            "User-Agent": "App/1.0 (+https://www.App.com)",
        }
    ...
    def send_profile_test_notifications(
        ...
        *,
        ...
        title = "App 通知测试" if zh else "App notification test"
        plain = (
            "这是一条来自 App 个人中心「通知设置」的测试消息。若您收到本条消息，说明该渠道配置正确。"
            if zh
            else "This is a test message from App profile notification settings. "
