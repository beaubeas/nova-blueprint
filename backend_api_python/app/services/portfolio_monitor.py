...
def _build_html_report(
    ...
    texts = {
        ...
        'subtitle': '由 App AI 快速分析引擎生成' if is_zh else 'Generated by App Fast AI Analysis Engine',
...
def _build_telegram_report(
    ...
    lines.extend([
        ...
        f"<i>{'由 App 多智能体系统生成' if is_zh else 'Generated by App Multi-Agent System'}</i>",
    ])
