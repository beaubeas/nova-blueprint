...
```sql
-- ============================================================
-- App V2.2.3 — qd_users.timezone（用户资料时区）
-- ============================================================
...
DO $$
BEGIN
    RAISE NOTICE '✅ App V2.2.2 database migration completed!';
END $$;
```
...
DO $$
BEGIN
    RAISE NOTICE '✅ App V2.2.1 database migration completed!';
END $$;
```
...
DO $$
BEGIN
    RAISE NOTICE '✅ App V2.1.1 database migration completed!';
END $$;
```
