...
App supports US stocks live trading via Interactive Brokers TWS or IB Gateway.
...
When running App in Docker, TWS/IB Gateway must be accessible from the container:
